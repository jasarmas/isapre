...
export const beneficios = {
  ...
  subtitle:  'No somos una Isapre. Somos tu aliado para entender el sistema y tomar la mejor decisión.',
  items: [
    {
      icon:        'BadgeCheck',
      title:       'Asesoría 100% gratuita',
      description: 'Sin costos ocultos ni comisiones a tu cargo. Nuestro servicio es completamente gratuito para ti y tu familia.',
    },
    {
      icon:        'LayoutGrid',
      title:       'Comparamos todas las Isapres',
      description: 'Revisamos todas las opciones del mercado para que elijas con información completa y actualizada.',
    },
    {
      icon:        'HandHeart',
      title:       'Te acompañamos en el proceso',
      description: 'Desde la primera consulta hasta el cambio efectivo, estamos contigo en cada paso.',
    },
    {
      icon:        'FileText',
      title:       'Sin letra chica, todo claro',
      description: 'Explicamos cada cláusula en lenguaje simple para que sepas exactamente qué estás contratando.',
    },
  ],
}
...
export const contacto = {
  ...
  subtitle:   'Déjanos tus datos y te contactamos en menos de 24 horas. Sin compromiso.',
  fields: {
    ...
    mensaje:      { label: 'Mensaje (opcional)', placeholder: '¿Tienes alguna duda o situación especial que quieras contarnos?' },
  },
  ctaLabel:         'Enviar consulta',
  ctaLoadingLabel:  'Enviando...',
  successMessage:   '¡Mensaje enviado! Te contactaremos en menos de 24 horas.',
  errorMessage:     'Hubo un error al enviar. Por favor intenta de nuevo o escríbenos por WhatsApp.',
}
